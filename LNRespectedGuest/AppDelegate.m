...
- (void)saveContext {
    ...
    if (managedObjectContext != nil) {
        ...
        if ([managedObjectContext hasChanges] && ![managedObjectContext save:&error]) {
            ...
            // abort() causes the application to generate a crash log and termnate. You should not use this function in a shipping application, although it may be useful during development.
            NSLog(@"Unresolved error %@, %@", error, [error userInfo]);
            abort();
        }
    }
